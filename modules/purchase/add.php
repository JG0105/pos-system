...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        if($purchase->create($purchaseData, $_POST['items'])) {
            $_SESSION['status_message'] = 'Purchase order created successfully';
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-6">
            <h1><i class="fas fa-shopping-basket"></i> New Purchase Order</h1>
        </div>
